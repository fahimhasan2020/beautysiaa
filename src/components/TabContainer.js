import { StyleSheet, Text, View,Dimensions,StatusBar,TextInput,ScrollView } from 'react-native'
...
const TabContainer = ({children}) => {
  return (
    <View style={{width:width}}>
      <View style={{width:width,height:122+StatusBar.currentHeight,backgroundColor:'#fff',elevation:3,padding:5,paddingTop:StatusBar.currentHeight}}>
