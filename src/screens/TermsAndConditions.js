    ...
    <Container>
        <StackContainer title="Terms & Conditions">
            ...
            <WebView
                ...
                <WebView
                    showsVerticalScrollIndicator={false}
                    source={{ html: '<p style="text-align:justify;font-size:30px;color:black;font-family: sans-serif;">All payments must be made by credit card or other means acceptable to Beautysiaa. You represent and warrant that you have the legal right to use any credit card or other payment method that you provide to us.</p>' }}
                    style={{width:sizes.width-40,height:70}}
                />
                
                <Text style={styles.headline}>Pricing and availability</Text>
                <WebView
                    showsVerticalScrollIndicator={false}
                    source={{ html: '<p style="text-align:justify;font-size:30px;color:black;font-family: sans-serif;">All payments must be made by credit card or other means acceptable to Beautysiaa. You represent and warrant that you have the legal right to use any credit card or other payment method that you provide to us.</p>' }}
                    style={{width:sizes.width-40,height:70}}
                ...
                <Text style={styles.headline}>Ordering and purchasing</Text>
                <WebView
                    showsVerticalScrollIndicator={false}
                    source={{ html: '<p style="text-align:justify;font-size:30px;color:black;font-family: sans-serif;">All payments must be made by credit card or other means acceptable to Beautysiaa. You represent and warrant that you have the legal right to use any credit card or other payment method that you provide to us.</p>' }}
                    style={{width:sizes.width-40,height:70}}
