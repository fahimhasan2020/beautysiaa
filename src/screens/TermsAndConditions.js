...
const {t,i18n} = useTranslation();
  return (
    <Container>
        <StackContainer title={t('termsAndConditions')}>
            ...
            <WebView
                ...
                <WebView
                    showsVerticalScrollIndicator={false}
                    source={{ html: `<meta name="viewport" content="initial-scale=0.1, maximum-scale=0.1"><p style="text-align:justify;font-size:30px;color:${theme === 'dark'?colors.lightModeBg:colors.darkModeBg};font-family: sans-serif;">The Website may be used only for lawful purposes and in a lawful manner. You agree to comply with all applicable laws, rules, and regulations in connection with your use of the Website. You may not use the Website in any manner that could damage, disable, overburden, or impair the Website or interfere with any other party’s use of the Website.</p>` }}
                    style={{width:sizes.width-40,height:100,backgroundColor:theme === 'dark'?colors.darkModeBg:colors.lightModeBg}}
                />
                ...
                <WebView
                    showsVerticalScrollIndicator={false}
                    source={{ html: `<meta name="viewport" content="initial-scale=0.1, maximum-scale=0.1"><p style="text-align:justify;font-size:30px;color:${theme === 'dark'?colors.lightModeBg:colors.darkModeBg};font-family: sans-serif;">All payments must be made by credit card or other means acceptable to Beautysiaa. You represent and warrant that you have the legal right to use any credit card or other payment method that you provide to us.</p>` }}
